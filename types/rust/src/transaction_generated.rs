...
pub mod transaction {
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> StorageKeyBuilder<'a, 'b, A> {
        ...
        pub fn add_value(&mut self, value: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(StorageKey::VT_VALUE, value);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> StorageKeyBuilder<'a, 'b, A> {
    ...
    impl<'a> AccessListItem<'a> {
        ...
        >(
            ...
            if let Some(x) = args.storage_key {
                builder.add_storage_key(x);
            }
        ...
        pub fn storage_key(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<StorageKey<'a>>>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<StorageKey>>,
                >>(AccessListItem::VT_STORAGE_KEY, None)
            }
        }
    }
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<StorageKey>>,
                >>("storage_key", Self::VT_STORAGE_KEY, false)?
                .finish();
            Ok(())
        }
    }
    pub struct AccessListItemArgs<'a> {
        ...
        pub storage_key: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<StorageKey<'a>>>,
            >,
        >,
    }
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> AccessListItemBuilder<'a, 'b, A> {
        ...
        pub fn add_address(
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(AccessListItem::VT_ADDRESS, address);
        }
        #[inline]
        pub fn add_storage_key(
            &mut self,
            storage_key: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<StorageKey<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                AccessListItem::VT_STORAGE_KEY,
                storage_key,
            );
        }
        #[inline]
    ...
    impl<'a> Transaction<'a> {
        ...
        >(
            ...
            if let Some(x) = args.gas_priority_fee {
                builder.add_gas_priority_fee(x);
            }
            ...
            if let Some(x) = args.transact_to {
                builder.add_transact_to(x);
            }
        ...
        pub fn gas_limit(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(Transaction::VT_GAS_LIMIT, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        ...
        pub fn gas_priority_fee(&self) -> Option<flatbuffers::Vector<'a, u8>> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(
                        Transaction::VT_GAS_PRIORITY_FEE,
                        None,
                    )
            }
        }
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> TransactionBuilder<'a, 'b, A> {
        ...
        pub fn add_caller(&mut self, caller: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Transaction::VT_CALLER, caller);
        }
        #[inline]
        pub fn add_gas_limit(&mut self, gas_limit: u64) {
            self.fbb_
                .push_slot::<u64>(Transaction::VT_GAS_LIMIT, gas_limit, 0);
        }
        #[inline]
        pub fn add_gas_price(
            &mut self,
            gas_price: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                Transaction::VT_GAS_PRICE,
                gas_price,
        ...
        #[inline]
        pub fn add_transact_to(
            &mut self,
            transact_to: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                Transaction::VT_TRANSACT_TO,
                transact_to,
        ...
        pub fn add_value(&mut self, value: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Transaction::VT_VALUE, value);
        }
        #[inline]
        pub fn add_data(&mut self, data: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Transaction::VT_DATA, data);
        }
        #[inline]
        pub fn add_gas_priority_fee(
            &mut self,
            gas_priority_fee: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                Transaction::VT_GAS_PRIORITY_FEE,
                gas_priority_fee,
