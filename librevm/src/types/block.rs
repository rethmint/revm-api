...
use crate::{ memory::ByteSliceView, v1::block::{ Block } };
...
impl From<BlockProto> for BlockEnv {
    fn from(block: BlockProto) -> Self {
                    ...
                    Some(BlobExcessGasAndPrice {
                        ...
                        blob_gasprice: u128::from_be_bytes(
                            blob_excess_gas_and_price.blob_gasprice
                                .try_into()
                                .map_err(|_| "Overflow the gas price")
                                .unwrap()
                        ),
                    })
                }
...
impl TryFrom<ByteSliceView> for BlockEnv {
    ...
    fn try_from(value: ByteSliceView) -> Result<Self, Self::Error> {
        ...
        Ok(BlockEnv::from(BlockProto::from(Block::decode(block_bytes).unwrap())))
    }
}
