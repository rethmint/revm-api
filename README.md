...
<!-- AUTO GENERATED BY libmrevm_builds.py START -->
| OS family       | Arch    | Linking | Supported                     | Note    |
| --------------- | ------- | ------- | ----------------------------- | ------- |
| Linux (glibc)   | x86_64  | shared  | ✅​libmrevm.x86_64.so         |  |
...
| Linux (glibc)   | aarch64 | shared  | ✅​libmrevm.aarch64.so        |  |
| Linux (glibc)   | aarch64 | static  | 🚫​                            |  |
| Linux (musl)    | x86_64  | shared  | 🚫​                            | Possible but not needed |
| Linux (musl)    | x86_64  | static  | ✅​libmrevm_muslc.x86_64.a    |  |
| Linux (musl)    | aarch64 | shared  | 🚫​                            | Possible but not needed |
| Linux (musl)    | aarch64 | static  | ✅​libmrevm_muslc.aarch64.a   |  |
| macOS           | x86_64  | shared  | ✅​libmrevm.dylib             |  |
| macOS           | x86_64  | static  | 🚫​                            |  |
| macOS           | aarch64 | shared  | ✅​libmrevm.dylib             |  |
| macOS           | aarch64 | static  | 🚫​                            |  |
<!-- AUTO GENERATED BY libmrevm_builds.py END -->
