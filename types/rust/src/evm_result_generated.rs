...
pub mod result {
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> TopicBuilder<'a, 'b, A> {
        ...
        pub fn add_value(&mut self, value: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Topic::VT_VALUE, value);
        }
        #[inline]
    ...
    impl<'a> LogData<'a> {
        ...
        pub fn topics(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Topic<'a>>>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Topic>>,
                >>(LogData::VT_TOPICS, None)
            }
        }
        #[inline]
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<Topic>>,
    ...
    pub struct LogDataArgs<'a> {
        pub topics: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Topic<'a>>>,
            >,
        >,
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> LogDataBuilder<'a, 'b, A> {
        ...
        pub fn add_topics(
            ...
            topics: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<Topic<'b>>>,
            >,
        ) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(LogData::VT_TOPICS, topics);
        }
        #[inline]
        pub fn add_data(&mut self, data: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(LogData::VT_DATA, data);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> LogDataBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            LogDataBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    impl<'a> Log<'a> {
        ...
        pub fn data(&self) -> Option<LogData<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<LogData>>(Log::VT_DATA, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> LogBuilder<'a, 'b, A> {
        ...
        pub fn add_address(
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Log::VT_ADDRESS, address);
        }
        #[inline]
        pub fn add_data(&mut self, data: flatbuffers::WIPOffset<LogData<'b>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<LogData>>(Log::VT_DATA, data);
        }
        #[inline]
    ...
    impl<'a> Success<'a> {
        ...
        >(
            ...
            if let Some(x) = args.deployed_address {
                builder.add_deployed_address(x);
            }
        ...
        pub fn reason(&self) -> SuccessReasonEnum {
            ...
            unsafe {
                self._tab
                    .get::<SuccessReasonEnum>(Success::VT_REASON, Some(SuccessReasonEnum::Stop))
                    .unwrap()
            }
        }
        #[inline]
        ...
        pub fn gas_refunded(&self) -> u64 {
            ...
            unsafe {
                self._tab
                    .get::<u64>(Success::VT_GAS_REFUNDED, Some(0))
                    .unwrap()
            }
        }
        #[inline]
        pub fn logs(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Log<'a>>>> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SuccessBuilder<'a, 'b, A> {
        ...
        pub fn add_reason(&mut self, reason: SuccessReasonEnum) {
            self.fbb_.push_slot::<SuccessReasonEnum>(
                Success::VT_REASON,
                reason,
                SuccessReasonEnum::Stop,
            );
        ...
        pub fn add_gas_used(&mut self, gas_used: u64) {
            self.fbb_
                .push_slot::<u64>(Success::VT_GAS_USED, gas_used, 0);
        }
        #[inline]
        pub fn add_gas_refunded(&mut self, gas_refunded: u64) {
            self.fbb_
                .push_slot::<u64>(Success::VT_GAS_REFUNDED, gas_refunded, 0);
        }
        #[inline]
        pub fn add_logs(
            &mut self,
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Success::VT_LOGS, logs);
        }
        #[inline]
        pub fn add_output(&mut self, output: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Success::VT_OUTPUT, output);
        }
        #[inline]
        pub fn add_deployed_address(
            &mut self,
            deployed_address: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>,
        ) {
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> RevertBuilder<'a, 'b, A> {
        ...
        pub fn add_output(&mut self, output: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Revert::VT_OUTPUT, output);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ...
    impl<'a> Halt<'a> {
        ...
        pub fn reason(&self) -> HaltReasonEnum {
            ...
            unsafe {
                self._tab
                    .get::<HaltReasonEnum>(Halt::VT_REASON, Some(HaltReasonEnum::OutOfGasBasic))
                    .unwrap()
            }
        }
        #[inline]
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> HaltBuilder<'a, 'b, A> {
        ...
        pub fn add_reason(&mut self, reason: HaltReasonEnum) {
            self.fbb_.push_slot::<HaltReasonEnum>(
                Halt::VT_REASON,
                reason,
                HaltReasonEnum::OutOfGasBasic,
            );
    ...
    impl<'a> EvmResult<'a> {
        ...
        pub fn result_type(&self) -> ExResult {
            ...
            unsafe {
                self._tab
                    .get::<ExResult>(EvmResult::VT_RESULT_TYPE, Some(ExResult::NONE))
                    .unwrap()
            }
        }
        #[inline]
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_union::<ExResult, _>(
                    ...
                    |key, v, pos| match key {
                        ExResult::Success => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<Success>>(
                                "ExResult::Success",
                                pos,
                            ),
                        ExResult::Revert => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<Revert>>(
                                "ExResult::Revert",
                                pos,
                            ),
                        ExResult::Halt => v
                            .verify_union_variant::<flatbuffers::ForwardsUOffset<Halt>>(
                                "ExResult::Halt",
                                pos,
                            ),
                        ExResult::Error => v
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> EvmResultBuilder<'a, 'b, A> {
        ...
        pub fn add_result_type(&mut self, result_type: ExResult) {
            self.fbb_
                .push_slot::<ExResult>(EvmResult::VT_RESULT_TYPE, result_type, ExResult::NONE);
        }
        #[inline]
        pub fn add_result(&mut self, result: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(EvmResult::VT_RESULT, result);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> EvmResultBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
            EvmResultBuilder {
                fbb_: _fbb,
                start_: start,
    ...
    pub fn size_prefixed_root_as_evm_result(
        buf: &[u8],
    ) -> Result<EvmResult, flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_evm_result_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
        fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        root: flatbuffers::WIPOffset<EvmResult<'a>>,
    ) {
