...
fn test_ffi_revm_initialize_function() {
    let call_request = CallRequest {
        transaction: CallTransaction {
            sender: Some(
                Address::from_word(address!("d8da6bf26964af9d7eed9e03e53415d37aa96045").into_word())
            ),
...
fn test_revm_initialize_function() {
    ...
    env.tx.caller = Address::from_word(
        address!("e100713fc15400d1e94096a545879e7c6407001e").into_word()
    );
    ...
    env.block.coinbase = Address::from_word(
        address!("00000000000000000000000000000000c014bace").into_word()
    );
